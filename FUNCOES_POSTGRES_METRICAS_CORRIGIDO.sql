-- =====================================================
-- FUNÇÕES CORRIGIDAS COM NOMES DE TABELAS ENTRE ASPAS
-- =====================================================
-- Execute este arquivo se as tabelas foram criadas pelo Hibernate/JPA
-- (nomes case-sensitive)

-- =====================================================
-- 1. FUNÇÃO: CALCULAR TAXA DE RETORNO (CORRIGIDA)
-- =====================================================
...
-- =====================================================
-- 2. FUNÇÃO: OBTER TODAS MÉTRICAS DE UMA VEZ (CORRIGIDA)
-- =====================================================
...
-- =====================================================
-- 3. FUNÇÃO: FATURAMENTO MENSAL AGREGADO (CORRIGIDA)
-- =====================================================
...
-- =====================================================
-- 4. FUNÇÃO: SERVIÇOS MAIS AGENDADOS (CORRIGIDA)
-- =====================================================
...
-- =====================================================
-- 5. FUNÇÃO: HORÁRIOS MAIS PROCURADOS (CORRIGIDA)
-- =====================================================
...
-- =====================================================
-- 6. FUNÇÃO: CLIENTES NOVOS VS RECORRENTES (CORRIGIDA)
-- =====================================================
...
-- Teste 2: Testar métricas completas (mês atual)
SELECT * FROM obter_metricas_completas(
    DATE_TRUNC('month', CURRENT_DATE)::DATE,
    (DATE_TRUNC('month', CURRENT_DATE) + INTERVAL '1 month - 1 day')::DATE
);

-- Teste 3: Testar faturamento mensal
...
-- =====================================================
-- SE AINDA DER ERRO: DESCOBRIR NOMES CORRETOS
-- =====================================================
-- Execute esta query para ver os nomes exatos das tabelas:
SELECT 
    table_name,
    (SELECT COUNT(*) FROM information_schema.columns 
     WHERE table_schema = 'public' 
     AND information_schema.columns.table_name = pg_tables.tablename) as num_colunas
FROM pg_tables
