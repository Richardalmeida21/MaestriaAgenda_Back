...
public class Expense {
    ...
    public Expense(String description, String category, LocalDate date, Double amount, Boolean paid, Boolean isFixo, Integer dayOfMonth, LocalDate endDate, Long recurringExpenseId) {
        this.description = description;
        this.category = category;
        this.date = date;
        this.amount = amount;
