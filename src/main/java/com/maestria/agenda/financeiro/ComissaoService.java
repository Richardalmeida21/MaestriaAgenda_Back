...
public class ComissaoService {
        ...
        for (Agendamento agendamento : agendamentosNormais) {
            if (agendamento.getPago() != null && agendamento.getPago() &&
                ...
                logger.debug(
                        ...
                        agendamento.getId(), valorServico, comissaoPercentualServico, comissaoServico, taxa,
                        descontoTaxa);
            }
        }
    ...
    public ComissaoResponseDTO calcularComissaoPorPeriodo(Long profissionalId, LocalDate inicio, LocalDate fim) {
        try {
            ...
            double valorJaPago = comissaoPagamentoRepository.calcularValorTotalPagoNoPeriodo(profissionalId, inicio,
                    fim);
